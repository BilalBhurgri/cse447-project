...
class DistilGPT2Model:
    ...
    def save(self, work_dir):
        ...
        model_path = os.path.join(work_dir, 'model_distilgpt2')
    ...
    def load(cls, work_dir):
        ...
        if not os.path.exists(model_path):
            ...
            print('Using base DistilGPT-2 model without fine-tuning.')
            return cls()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_output', help='path to write test predictions', default='pred_distilgpt2.txt')
    ...
    if args.mode == 'train':
        ...
        print('Instantiating DistilGPT-2 model')
        ...
        if os.path.isdir(args.train_data):
            for d in os.listdir(args.train_data):
                ...
                if os.path.isdir(f_dir) and d.startswith("fleurs"):
                    try:
                        train_data.extend(DistilGPT2Model.load_training_data(f_dir))
                    except Exception as e:
        ...
        print('Loading model')
        model = DistilGPT2Model.load(args.work_dir)
        
        print('Loading test data from {}'.format(args.test_data))
        test_data = DistilGPT2Model.load_test_data(args.test_data)
