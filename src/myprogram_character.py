...
class MyModel:
    ...
    # --------------------------------------------------------
    # SAME DATA LOADING FORMAT AS YOUR GPT2 FILE
    # --------------------------------------------------------
    ...
    def _create_dataset(self, texts):
        ...
        for i in range(0, len(all_ids) - self.seq_len - 1, stride):
    ...
    def save(self, work_dir):
        ...
        }, os.path.join(work_dir, "model_5k.pt"))
        print("Model saved.")

    @classmethod
    def load(cls, work_dir):
        checkpoint = torch.load(os.path.join(work_dir, "model_5k.pt"))
